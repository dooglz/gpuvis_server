...
GPUVIS_SIMULATOR_EXPORT const int loadProgram(const std::string& pgrm, const std::string& name = "PROGRAM");
GPUVIS_SIMULATOR_EXPORT const int loadSource(int pgrmid, const std::string& pgrm);
